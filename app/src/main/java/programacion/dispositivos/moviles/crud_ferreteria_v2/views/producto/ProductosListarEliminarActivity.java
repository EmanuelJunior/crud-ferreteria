...
public class ProductosListarEliminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_eliminar_productos);

        productoOps = new ProductoOperations(this);
        productoList = new ArrayList<>();

        Button btnVolverOperaciones = findViewById(R.id.btnVolverOperacionesDesdeEliminarProductos);
        ...
        listaProductos = findViewById(R.id.listaEliminarProductos);
    ...
    private void mostrarDetallesProducto(Producto producto) {
        Intent intent = new Intent(this, ProductoRenderizarEliminarActivity.class);
