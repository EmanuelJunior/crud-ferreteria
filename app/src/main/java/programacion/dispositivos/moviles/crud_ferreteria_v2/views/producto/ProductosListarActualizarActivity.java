...
public class ProductosListarActualizarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_actualizar_productos);

        productoOps = new ProductoOperations(this);
        productoList = new ArrayList<>();

        Button btnVolverOperaciones = findViewById(R.id.btnVolverOperacionesDesdeActualizarProductos);
        ...
        listaProductos = findViewById(R.id.listaActualizarProductos);
        listaProductos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Producto productoSeleccionado = (Producto) parent.getItemAtPosition(position);
                abrirActualizarProducto(productoSeleccionado.getProductoID());
            }
        });
    ...
    private void abrirActualizarProducto(int productoId) {
        Intent intent = new Intent(this, ProductoActualizarActivity.class);
