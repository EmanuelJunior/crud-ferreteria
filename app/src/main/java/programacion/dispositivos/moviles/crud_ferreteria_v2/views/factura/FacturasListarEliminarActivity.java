...
public class FacturasListarEliminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_eliminar_facturas);

        facturaOps = new FacturaOperations(this);
        facturaList = new ArrayList<>();

        Button btnVolverOperaciones = findViewById(R.id.btnVolverOperacionesDesdeEliminarFacturas);
        ...
        listaFacturas = findViewById(R.id.listaEliminarFacturas);
    ...
    private void mostrarDetallesFactura(Factura factura) {
        Intent intent = new Intent(this, FacturaRenderizarEliminarActivity.class);
        intent.putExtra("FACTURA_ID", factura.getFacturaID());
