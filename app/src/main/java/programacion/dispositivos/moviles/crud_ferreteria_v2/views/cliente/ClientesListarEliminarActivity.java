...
public class ClientesListarEliminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_eliminar_clientes);

        clienteOps = new ClienteOperations(this);
        clienteList = new ArrayList<>();

        Button btnVolverOperaciones = findViewById(R.id.btnVolverOperacionesDesdeEliminar);
        ...
        listaClientes = findViewById(R.id.listaEliminarClientes);
    ...
    private void mostrarDetallesCliente(Cliente cliente) {
        Intent intent = new Intent(this, ClienteRenderizarEliminarActivity.class);
